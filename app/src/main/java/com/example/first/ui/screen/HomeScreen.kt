...
package com.example.first.ui.screen
...
import com.example.first.data.Amphibian
...
fun LoadingScreen(modifier: Modifier = Modifier) {
    Image(
        painter = painterResource(R.drawable.ic_launcher_foreground), // Dùng icon có sẵn để tránh lỗi
    ...
    Card(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            AsyncImage(
                ...
                error = painterResource(id = R.drawable.ic_launcher_foreground), // Dùng icon có sẵn
                placeholder = painterResource(id = R.drawable.ic_launcher_foreground) // Dùng icon có sẵn
            )
            Text(
